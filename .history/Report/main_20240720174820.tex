...
\end{itemize}
We choose (1) to model SFH with a double exponential, (2) to employ the IMF by \citet{Chabrier_2003}, (3) to model SPS according to \citet{Bruzual_2003}, (4) to model dust attenuation with \citet{Calzetti_2000} and \citet{Leitherer_2002} formulae, and (5) to take into account also nebular emission. This is just a brief description of how CIGALE works, we suggest to check the original paper \citep{Boquien_2019} for the details.

Besides SFR, CIGALE provides a long series of valuable estimates of galactic quantities, such as $M_{\text{star}}$, age, and metallicity. In this work, we will focus on the sSFR versus $M_{\text{star}}$ plane.
