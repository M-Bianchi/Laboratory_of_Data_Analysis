...
We generate a population of galaxies that formed at different times $t_\text{form,i}$, all with the same initial halo mass $M_\text{halo}(t_\text{form,i})=5 \times 10^8$, and evolve them up to the current time.
