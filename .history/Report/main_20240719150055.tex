...
Galaxies are the fundamental building blocks of the universe at cosmological scales, and therefore it is crucial to understand how they form, evolve over time, and interact with one another to form more complex structures. However, they are also extremely heterogeneous in shape, size, color, age, and so on; capturing such diversity whithin a mathematical model is a very difficult task.

What are the physical processes that determine the quenching of the sSFR for a fraction of the more massive galaxies at low redshift? Is the development of such processes related to the age of the galaxy?
