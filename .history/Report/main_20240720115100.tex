...
In particular, gas inflow is strongly related to the properties of the dark matter halo that hosts the galaxy. This halo accretes matter at a certain rate from the intergalactic medium, and only a fraction $f_{\text{gas}}$ of it is gas, typically at very high temperatures. Such hot gas has a very strong pressure support which prevents it from accreting onto the galaxy. In order to gas infall to happen, the condition $\tau_{\text{cooling}} < \tau_{\text{free-fall}}$ is required.
