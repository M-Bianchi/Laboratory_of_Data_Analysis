...
Besides SFR, CIGALE provides a series of valuable estimates of galactic quantities, such as $M_{\text{star}}$, age, and metallicity. In this work, we will focus on the sSFR versus $M_{\text{star}}$ plane.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
