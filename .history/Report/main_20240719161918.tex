...
\begin{figure}
    ...
    \caption{The main panel shows a 2D histogram of sSFR versus $M_{\text{star}}$} for our dataset, with both axes in log-scale. The side panels display the marginal distributions of the two axes. The black, dashed line corresponds to the sSFR value at which the sSFR distribution has a local minimum and it is assumed to separate the main sequence from the quiescent galaxies.
    \label{fig:mass_sSFR}
\end{figure}
