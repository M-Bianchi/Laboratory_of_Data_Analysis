...
We can relax one more assumption by employing a model of $\xi$ which is more physically meaningful than a step function. For example, \citet{Dave_2011} developed a sophisticated function that takes into account many physical processes that influence accretion of gas from the halo.
