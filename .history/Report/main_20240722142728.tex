...
The main difference between the two is the presence of gas outflow: we set $\eta=0$ for the analytical case and $\eta=1.3$ in the numerical case. We could further generalize the time evolution by implementing a $\eta(t)$ that decreases as time goes by, as physics suggests.
