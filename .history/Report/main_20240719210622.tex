...
The raw material for star formation is gas, which under appropriate conditions can collapse and form a virialized object. The amount of gas within a galaxy is not constant and it is subject to a myriad of processes. Therefore, we expect sSFR to drop whenever the consumed gas is no longer replaced by new gas, coming either from stars or from outside the galaxy.
