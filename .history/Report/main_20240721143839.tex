...
\end{equation}
As shown in Fig.~\ref{fig:openbox_and_closedbox}, most passive galaxies exceed $M_{\text{star,max}}$
...
\begin{figure}
    ...
    \caption{2D scatterplot of sSFR versus $M_{\text{star}}$ for our dataset, where the color is proportional to the age. The black dashed line separates the main sequence from quiescent galaxies. The 25, 50, 75, and 95\% contours of both populations are shown.}
    \end{centering}
