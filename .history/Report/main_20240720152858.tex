...
We choose to (1) model the star formation history (SFH) with a double exponential, (2) employ the initial mass function (IMF) by \citet{Chabrier_2003}, (3) model the dust attenuation with \citet{Calzetti_2000} and  Leitherer et al. (2002) formulae, and (4) to take into account also nebular emission.
