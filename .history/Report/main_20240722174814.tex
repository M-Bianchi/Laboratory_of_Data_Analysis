...
This is just an example of the many assumptions we could relax, as galaxy evolution is an extremely complicated topic, that requires to make a vast number of assumptions and approximations.
