...
\begin{itemize}[left=6pt]
    ...
    \item \textbf{Stellar population synthesis (SPS):} describes the spectrum emitted by a certain stellar population at a given time. This population is formed according to a SFH and an \textbf{initial mass function (IMF)}, which describes the mass distribution of new stars.
\end{itemize}
