...
Galaxies are the fundamental building blocks of the universe at cosmological scales, and therefore it is crucial to understand how they form, evolve over time, and interact with one another to form more complex structures.

and they are extremely heterogeneous in shape, size, color, age, and so on. Therefore, modeling them is both very important and difficult.
