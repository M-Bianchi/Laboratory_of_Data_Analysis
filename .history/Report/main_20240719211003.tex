...
The raw material for star formation is gas, which under appropriate conditions can collapse and form a virialized object. The amount of gas within a galaxy is not constant and is subject to a myriad of processes, which depend on the main physical properties of the galaxy, such as age and mass. Therefore, we expect sSFR to drop whenever the consumed gas is no longer replaced by new one, coming either from stars (winds, supernovae) or from outside the galaxy.
