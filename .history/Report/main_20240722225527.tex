...
In conclusion, we discovered that it is indeed possible to describe the sSFR$(M_\text{star})$ bimodality in galaxies at low redshift through simple models, which can be complicated by adding more terms, if needed. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
