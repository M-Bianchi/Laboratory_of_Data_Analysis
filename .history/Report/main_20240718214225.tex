...
\begin{abstract}
Galaxies at low redshifts ($z<0.08$ for the data used here) display a bimodality in their specific star-formation-rate (sSFR). This observation is related to (1) the accretion processes that make galaxies grow, (2) the feedback processes that eject gas from the galaxies, (3) the environment in which galaxies evolve, and more. Most of these processes, in turn, strongly depend on the main physical properties of galaxies, like gas mass, stellar mass, and age. For this reason, it is possible to build a model which describes the evolution of sSFR in time based exclusively on simple quantities.
\bigskip
\end{abstract} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
