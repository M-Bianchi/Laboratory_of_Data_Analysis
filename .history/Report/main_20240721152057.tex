...
\end{equation}
As shown in Fig.~\ref{fig:mass_sSFR_age}, most passive galaxies exceed $M_{\text{star,max}}$ and therefore we expect them
Moreover, we can see that passive galaxies are, on average, far older than star-forming ones. This suggests that the formers may have 
