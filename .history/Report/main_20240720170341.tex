...
We choose (1) to model SFH with a double exponential, (2) to model stellar population synthesis (SPS) according to \citet{Bruzual_2003}, (3) to employ the initial mass function (IMF) by \citet{Chabrier_2003}, (4) to model dust attenuation with \citet{Calzetti_2000} and \citet{Leitherer_2002} formulae, and (5) to take into account also nebular emission.
