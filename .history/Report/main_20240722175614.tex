...
Introducing ram-pressure stripping and interactions between galaxies in our model would be even more complicated. For example, it is not obvious whether an interaction between to close neighbor galaxies would stimulate or quench their star-formation processes.
\begin{figure}\centering
