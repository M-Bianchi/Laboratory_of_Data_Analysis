...
\title[Short title, max. 45 characters]{Simple models to describe the star formation rate bimodality in SDSS galaxies at low redshift}
...
This work is based on a subset of the \textbf{Sloan Digital Sky Survey} (SDSS)
