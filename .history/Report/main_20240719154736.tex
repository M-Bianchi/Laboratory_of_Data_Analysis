...
Galaxies are the fundamental building blocks of the universe at cosmological scales. Therefore, understanding how they form, evolve over time, and interact to create more complex structures is crucial. However, capturing their extreme diversity within a mathematical model is a very challenging task, and thus strong assumpions and approximation are often required.

In this work, we tackle a small but important aspect of galaxies. In particular, we study the processes that determine the quenching of the specific Star Formation Rate (sSFR) for a fraction of the more massive galaxies at low redshift. In this context, it is well known that two major population can be identified in the $M_{\rm star}$-sSFR plane \citep[e.g.][]{Kauffmann_2003}
