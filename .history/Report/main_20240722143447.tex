...
Another difference is that, while for the analytical case $M_\text{gas}(t_0)$ is a free parameter that we have to choose, in the numerical approach it is the result of time evolution from the time of formation to when $\xi \approx 0$, i.e., when $M_\text{star}(t)\approx M_{\text{star,max}}$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
