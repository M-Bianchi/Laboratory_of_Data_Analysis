...
We choose to (1) model the star formation history (SFH) with a double exponential, (2) employ the Chabrier initial mass function (IMF), (3) model the dust attenuation with Calzetti et al. (2000) and  Leitherer et al. (2002) formulae, and (4) to take into account also nebular emission.
