...
On the other hand, gas can also be expelled from the galaxy due to various processes, such as supernovae, AGN emission, and ram-pressure stripping. In the following, we will assume type IIA supernovae to be the only source of gas outflow, as they are the dominant term.
