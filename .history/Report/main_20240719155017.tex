...
In this work, we tackle an important aspect of this mosaic. In particular, we study the processes that determine the quenching of the specific Star Formation Rate (sSFR) for a fraction of the more massive galaxies at low redshift. In this context, it is well known that two major population can be identified in the $M_{\rm star}$-sSFR plane \citep[e.g.][]{Kauffmann_2003}
