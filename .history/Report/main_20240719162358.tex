...
\begin{figure}
    ...
    \caption{The main panel shows a 2D histogram of sSFR versus $M_{\text{star}}$ for our dataset. The side panels display the marginal distributions of the two axes. The black, dashed line corresponds to the value at which the sSFR distribution has a local minimum and it is assumed to separate the main sequence from the quiescent galaxies. Finally, the 2D gaussian contours for each of the two populations are also displayed.}
    \label{fig:mass_sSFR}
\end{figure}
