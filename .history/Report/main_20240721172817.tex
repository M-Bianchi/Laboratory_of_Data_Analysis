...
{\fontsize{8.2pt}{8.2pt}\begin{equation}
    M^\text{eq}_\text{gas}\left(M_{\text{star}}\right) = \dfrac{\dot{M}_\text{gas}^\text{in}\left(M_{\text{star}}\right)}{(1+\eta-R)\epsilon'} \: \Rightarrow \: sSFR^\text{eq}(t) = \dfrac{\dot{M}_\text{gas}^\text{in}(t)}{1+\eta-R} \, \dfrac{1}{M_\text{star}},
