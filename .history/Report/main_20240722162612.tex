...
We could relax further approximations by considering more outflow processes. AGN emission and ram-pressure stripping in dense environments are both relevant processes, even though Type IIA supernovae are the dominant driver for gas ejection.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
