...
\begin{itemize}[left=6pt]
    ...
    \item \textbf{Stellar population synthesis (SPS):} describes the spectrum emitted by a stellar population at a certain time. Stars are formed according to an \textbf{initial mass function (IMF)}
\end{itemize}
