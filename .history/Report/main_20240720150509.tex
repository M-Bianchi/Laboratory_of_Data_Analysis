...
This work is based on a subset of the \textbf{Sloan Digital Sky Survey} (SDSS). In particular, we study $92483$ galaxies with redshift $< 0.08$ ($z_{\text{mean}} \simeq 0.054$), for which we have five-band photometric data. This data may look too sparse for an accurate estimation of the SFR, but we can achieve such estimate by employing a very sophisticated library called \textbf{CIGALE} (Code Investigating GALaxy Emission)
