...
In this context, it is well known \citep[e.g.,][]{Kauffmann_2003} that two main populations can be identified in the plane of specific Star Formation Rate (sSFR) versus stellar mass ($M_{\rm star}$): one of young, actively star-forming galaxies (main sequence) and the other of old, mostly passive galaxies, as shown in Fig.~\ref{fig:mass_sSFR}. In this work, we study the processes that determine the quenching of the sSFR for a fraction of the more massive galaxies at low redshift.
