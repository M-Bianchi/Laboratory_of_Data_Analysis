...
\end{equation}
As shown in Fig.~\ref{fig:mass_sSFR_age}, most ($\approx 64\%$) passive galaxies exceed $M_\text{star,max}$, and therefore, we expect them to have $\dot{M}_\text{gas}^\text{in} \approx 0$.
