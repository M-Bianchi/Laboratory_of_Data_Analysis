...
In this context, it is well known \citep[e.g.,][]{Kauffmann_2003} that two main populations can be identified in the plane of \textbf{specific star formation rate} (sSFR) versus \textbf{stellar mass} ($M_{\text{star}}$): one of young, actively star-forming galaxies (the \textit{main sequence}) and the other of old, mostly passive galaxies, as shown in Fig.~\ref{fig:mass_sSFR}. These two populations could be described by two different models, or a single model with a sharp transition past some threshold.
In this work, we investigate the processes that determine the quenching of sSFR for a fraction of the more massive galaxies at low redshift.
