...
{\fontsize{7.9pt}{7.9pt}\begin{equation}
	...
	\label{eq:mcbride}
\end{equation}}
There is still an unknown quantity, i.e., $M_\text{halo}$. We can estimate it by numerically-inverting the empirical relation found by \citet{Moster_2012}:
\begin{equation}
    \dfrac{M_\text{star}}{M_\text{halo}} = 2N \left[\left(\dfrac{M_\text{halo}}{M_1}\right)^{-\beta} + \left(\dfrac{M_\text{halo}}{M_1}\right)^\gamma\right]^{-1}.
	\label{eq:moster}
\end{equation}
