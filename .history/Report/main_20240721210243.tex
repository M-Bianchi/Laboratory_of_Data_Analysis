...
In the previous derivation of $sSFR\left(M_{\text{star}}\right)$ in the open-box model, we considered the inflow and outflow of gas to be equal. However, in general this is not the case.
