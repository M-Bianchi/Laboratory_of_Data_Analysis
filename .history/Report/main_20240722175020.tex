...
AGN emission is just one of the many assumptions we could relax, as galaxy evolution is an extremely complicated topic, that requires to make a vast number of assumptions and approximations in order to develop a simple model.
\begin{figure}\centering
